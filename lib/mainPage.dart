            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  child: Image.asset("assets/moriaLogoDik.png")), // Logo eklendi
              SizedBox(height: MediaQuery.of(context).size.height*0.01), // Aralığı ayarlamak için SizedBox eklendi
              Text(
                "Burçlar Hakkında Genel Bilgi:",
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 30, backgroundColor: Colors.white.withOpacity(0)), // Renk beyaz yapıldı
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 30, backgroundColor: Colors.white.withOpacity(0)),
              ),
              SizedBox(height: MediaQuery.of(context).size.height*0.01,),
              ElevatedButton(
                onPressed: () {
